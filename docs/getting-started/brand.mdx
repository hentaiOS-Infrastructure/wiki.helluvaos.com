...
The use of hentaiOS and helluvaOS brand on a marketing materials related to the builds is restricted to [Compliant Devices](../technical-data/intro) only. The following are guidelines for the hentaiOS and/or helluvaOS brand and related assets that can be used for compliant devices.
